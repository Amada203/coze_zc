...
# 构建绝对路径
json_file_path = os.path.join(current_dir, '价格数据时间序列特征.json')
...
# 保存模型
model_file_path = os.path.join(current_dir, 'lightgbm_price_prediction_model.txt')
...
result_file_path = os.path.join(current_dir, 'lightgbm价格预测结果.json')
